    ...
    if (isset($_SESSION["uname"]))
    {
        ...
        else
        {
            ...
            if($numofdisks > 0)
            {
                ...
                $sql = "UPDATE transaction SET type = 1 WHERE trans_id = '$trans_id'";
                $sql3 = "UPDATE transaction SET end_date = '$enddate' WHERE trans_id = '$trans_id'";
                //echo $sql;
                //Run the query
                ...
                echo "You cannot rent this movie because there are no disks available.<br>You have already reserved it so please wait for it to become available again.";
                echo "<br><br>";
